...
class HeartRiskEngine:
    ...
    def _apply_refinement(self, payload: dict, result: dict, answers: dict[str, str]) -> dict:
        refinement_points, confirmed = self._refinement_delta(answers)
        refined = result.copy()
        ...
        refined["refinement_summary"] = (
            "Your follow-up answers confirmed specific symptoms that sharpen the clinical picture and increase assessment confidence."
            if confirmed
    ...
    def refine(self, payload: dict, answers: dict[str, str]) -> dict:
